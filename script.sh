...
python convert_tf_checkpoint_to_pytorch.py --tf_checkpoint_path ~/pretrain/uncase_multilingual_L-12_H-768_A-12/bert_model.ckpt --bert_config_file ~/pretrain/uncase_multilingual_L-12_H-768_A-12/bert_config.json --pytorch_dump_path ~/pretrain/uncase_multilingual_L-12_H-768_A-12/pytorch_model.bin


python run_classifier_TABSA.py --task_name semeval_term_NLI_M --data_dir data/indo_peter/bert-pair/ --vocab_file uncase_multilingual_L-12_H-768_A-12/vocab.txt --bert_config_file uncase_multilingual_L-12_H-768_A-12/bert_config.json --init_checkpoint uncase_multilingual_L-12_H-768_A-12/pytorch_model.bin --eval_test --do_lower_case --max_seq_length 512 --train_batch_size 2 --learning_rate 2e-5 --num_train_epochs 6.0 --output_dir results/indo_peter/term_NLI_M --seed 42 --no_augmentation
