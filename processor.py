...
class Semeval_term_QA_M_Processor(Semeval_QA_M_Processor):
    def get_train_examples(self, data_dir):
        """See base class."""
        train_data = pd.read_csv(os.path.join(data_dir, "train_term_QA_M.csv"), header=None, sep="\t").values
        return self._create_examples(train_data, "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        dev_data = pd.read_csv(os.path.join(data_dir, "dev_term_QA_M.csv"), header=None, sep="\t").values
        return self._create_examples(dev_data, "dev")

    def get_test_examples(self, data_dir):
        """See base class."""
        test_data = pd.read_csv(os.path.join(data_dir, "test_term_QA_M.csv"), header=None, sep="\t").values
        return self._create_examples(test_data, "test")
...
class Semeval_term_NLI_B_Processor(Semeval_NLI_B_Processor):
    def get_train_examples(self, data_dir):
        """See base class."""
        train_data = pd.read_csv(os.path.join(data_dir, "train_term_NLI_B.csv"), header=None, sep="\t").values
        return self._create_examples(train_data, "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        dev_data = pd.read_csv(os.path.join(data_dir, "dev_term_NLI_B.csv"), header=None, sep="\t").values
        return self._create_examples(dev_data, "dev")
...
class Semeval_term_QA_B_Processor(Semeval_QA_B_Processor):
    ...
    def get_train_examples(self, data_dir):
        """See base class."""
        train_data = pd.read_csv(os.path.join(data_dir, "train_term_QA_B.csv"), header=None, sep="\t").values
        return self._create_examples(train_data, "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        dev_data = pd.read_csv(os.path.join(data_dir, "dev_term_QA_B.csv"), header=None, sep="\t").values
        return self._create_examples(dev_data, "dev")

    def get_test_examples(self, data_dir):
        """See base class."""
        test_data = pd.read_csv(os.path.join(data_dir, "test_term_QA_B.csv"), header=None, sep="\t").values
        return self._create_examples(test_data, "test")