...
dir_path = [data_dir + 'bert-single_term/' + i + '/' for i in aspect_name]
    ...
    while s:
        ...
        if "<sentence id" in s:
            ...
            if "anecdotes/miscellaneous" in category:
                g_anecdotes.write(id + "\t" + polarity[
                    category.index("anecdotes/miscellaneous")] + "\t" + "anecdotes" + "\t" + text + "\n")
            else:
            ...
            if "ambience" in category:
                g_ambience.write(
                    id + "\t" + polarity[category.index("ambience")] + "\t" + "ambience" + "\t" + text + "\n")
            else:
