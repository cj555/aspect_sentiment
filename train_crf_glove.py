...
def evaluate_test(model_dict, test_by_aspect, args, sample_out=False, is_validate=True):
    ...
    f1 = round(f1_score(all_labels, all_predictions, average='macro'),3)
    acc = round(accuracy_score(all_labels, all_predictions),3)
